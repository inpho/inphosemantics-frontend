function main() {
	...
	function renderTable(corpora, models, phrases) {
		...
		for (var i=0; i<phrases.length; i++) {
		    ...
		    $(this).append(
			"<td><table class='table' id='"+$(this).closest("table").attr("id")+":"+phrase+"'><thead><tr><th colspan='2' style='text-align: center;'>"+phrase+"</th></tr><tr><th style='text-align: center;'>Phrase</th><th style='text-align: center;'>Similarity</th></tr></thead><tbody></tbody></table></td>"
		    );
		}
	    });
	}
	...
	function renderColumn(data, element){
		...
		for(key in data[i]){
		    ...
		    $(element).append("<tr><td style='text-align: center;'>"+key+"</td><td style='text-align: center;'>"+data[i][key]+"</td></tr>");
		}
	    }
	}
	...
	$("#querySubmit").click(function(){
		...
		for(var mi = 0; mi < models.length; mi++){
			...
			var successCallBack = function(parent){
			...
			var errorCallBack = function(parent){
